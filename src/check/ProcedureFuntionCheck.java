	...
	public void check() {
		...
		for (StoredProcedure p1:schemaA.getStoreprocedures() ){
			...
			if (!exist) 
				...
				System.out.println(" El procedimiento " + p1.getName() + " del schema " + schemaA.getName() + " existe en el schema "+ schemaB.getName());
		}
		...
		for (StoredProcedure p1:schemaB.getStoreprocedures() ){
			...
			if (!exist) 
				...
				System.out.println(" El procedimiento " + p1.getName() + " del schema " + schemaB.getName() + " existe en el schema "+ schemaA.getName());
		...
		for (Function f1:schemaA.getFunctions() ){
			...
			if (!exist) 
				System.out.println(" La funcion "+ f1.getName() + " del schema " + schemaA.getName() + " no existe en el schema "+ schemaB.getName());
			else
				System.out.println(" La funcion "+ f1.getName() + " del schema " + schemaA.getName() + " existe en el schema "+ schemaB.getName());
		}
		...
		for (Function f1:schemaB.getFunctions() ){
			...
			if (!exist) 
				System.out.println(" La funcion "+ f1.getName() + " del schema " + schemaB.getName() + " no existe en el schema "+ schemaA.getName());
			else
				System.out.println(" La funcion "+ f1.getName() + " del schema " + schemaB.getName() + " existe en el schema "+ schemaA.getName());
		}
